...
(1, 'name', 'ATTENDINK-QR BASED ATTENDANCE'),
(2, 'address', 'CHENNAI'),
(3, 'contact', '9566366903'),
(4, 'email', 'sakthisharan@gmail.com'),
(5, 'fb_page', 'https://www.facebook.com/Sakthisharan'),
(6, 'short_name', 'ATTENDINK'),
